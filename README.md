...
|**useLogFile**|false|**If you want logs to work set this to true**|
|**logFileChannelID**|None|**Must set this if useLogFile is set to true!** Suggestion: Keep it same as logChannelId|
